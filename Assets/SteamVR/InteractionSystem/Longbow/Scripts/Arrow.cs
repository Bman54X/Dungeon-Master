...
namespace Valve.VR.InteractionSystem
{
	...
	public class Arrow : MonoBehaviour
	{
		...
		public void ArrowReleased( float inputVelocity )
		{
			...
			{
				if ( hit.collider.gameObject != gameObject && hit.collider.gameObject != arrowHeadRB.gameObject && hit.collider != Player.instance.headCollider && hit.collider.gameObject.tag !="Arrow" )
				{
					Destroy( gameObject );
					return;
				}
